...
```{r}
default_sample <- per_data[per_data$month_no>=201607 & per_data$month_no<=201611 & per_data$loan_org_month_no<=201606 & per_data$loan_org_month_no>=201406 & per_data$loan_age>2 & per_data$loan_age<=per_data$loan_term & per_data$last_payment_date>="2016-08-01",]#
