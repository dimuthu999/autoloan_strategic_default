...
lb_data['ltv'] <- lb_data$loan_amount/lb_data$valuation_org
...
file_names <- c("E:/auto_strategicdefault/Raw Data/lb_performance/2014_1.csv")
...
used_value <- used_value[used_value$vehicle_year %in% c(2013:2015),]
used_value$used_vehicle_value <- ifelse(used_value$vehicle_year != 2013, NA,used_value$used_vehicle_value)
