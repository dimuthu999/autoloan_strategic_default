...
default_sample <- per_data[per_data$month_no>=201502 & per_data$month_no<=201508 & per_data$loan_org_month_no<=201407 & per_data$loan_org_month_no>=201101 & per_data$loan_age<=per_data$loan_term & per_data$last_payment_date>="2015-08-01",]
default_sample['treat'] <- ifelse(default_sample$type=="threewheeler",1,0)
